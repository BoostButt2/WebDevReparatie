...
async function getUserInfo(){
    ...
    await fetch('https://localhost:7133/api/User/getplayers', {
        method: 'GET',
        headers: headers
    })
        .then(response => {
            response.json().then(data => {
                data.forEach(function (user){
                    ...
                    userForm.addEventListener("submit", async(event) =>{
                        ...
                        await fetch('https://localhost:7133/api/User/editUserrole', {
                            method: 'POST',
                            headers: headers,
                    ...
                    deleteButton.addEventListener("click", async (event) =>{
                        ...
                        await fetch('https://localhost:7133/api/User/' + user.userid.toString(), {
                            method: 'DELETE',
                            headers: headers
                        })
                            .then(response => {
